    ...
    return (
        <div className="fixed inset-0 z-40 bg-white flex flex-col h-screen">
            ...
            <header className="flex justify-between items-center px-6 sm:px-10 py-4 border-b bg-gray-50">
                <h1 className="text-2xl font-bold text-gray-900 truncate">{ tryout.name }</h1>
                <button
                    onClick={ onCancel }
            ...
            <main className="flex-1 flex flex-col px-6 sm:px-10 py-8 max-w-3xl mx-auto w-full">
                {/* Bagian atas: Spesifikasi + tombol */ }
                <div className="mb-6">
                                            ...
                                            return (
                                                <tr key={ idx } className="bg-white border-b last:border-b-0">
                                                    ...
                                                    <td className="px-4 py-2 text-sm">
                                                        <span className={ `px-2 py-1 rounded-full text-white text-xs ${ passed ? "bg-green-500" : "bg-red-500" }` }>
